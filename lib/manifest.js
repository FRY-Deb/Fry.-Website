    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "CHEESE. FRY. (7 uds)", desc: "Bolitas de queso fundente, con el mismo rebozado crujiente del pollo. 7 unidades — sale más a cuenta.", price: "6,90€" },
      ...
      },
      {
        id: "salsas",
        label: "Salsas Extra",
        note: "Se sirven en biberón, para echar por encima del pollo.",
        items: [
          ...
          { name: "Salsa Bourbon", desc: "Glaseado dulce y ahumado con bourbon real, sirope de arce puro y un fondo de mostaza y soja.", price: "1,90€" },
          { name: "Salsa Sweet Chilli", desc: "Guindilla fresca y ajo salteado, dulce con un toque picante de fondo.", price: "1,00€" },
          { name: "Salsa Habanero Mango", desc: "Mango fresco y habanero, picante afrutado y con punch.", price: "1,20€" },
        ],
      },
      {
        id: "bebidas",
        ...
        items: [
          { name: "Coca-Cola", desc: "Botella 500 ml.", price: "2,90€" },
          { name: "Coca-Cola Zero", desc: "Botella 500 ml.", price: "2,90€" },
          { name: "Fanta Naranja", desc: "Botella 500 ml.", price: "2,90€" },
          { name: "Aquarius Limón", desc: "Botella 500 ml.", price: "2,90€" },
          { name: "Nestea", desc: "Botella 500 ml.", price: "2,90€" },
          { name: "Agua Embotellada", desc: "500 ml.", price: "1,20€" },
          { name: "Fanta Naranja 2L", desc: "Formato familiar, para compartir.", price: "4,50€" },
          { name: "Fuze Tea 1,5L", desc: "Formato familiar, para compartir.", price: "4,90€" },
          { name: "Coca-Cola Zero 2L", desc: "Formato familiar, para compartir.", price: "4,70€" },
        ],
      },
    ],
