  ...
  window.__BRAND__ = {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          { name: "Patatas Especiales FRY. — Pequeña", desc: "150g de patatas cajún + tarrina de Salsa Ranch FRY (40g) + tarrina de miel (40g).", price: "5,20€" },
          { name: "Patatas Especiales FRY. — Grande", desc: "800g de patatas cajún + tarrina de Salsa Ranch FRY (200g) + 2 tarrinas de miel (40g c/u).", price: "10,00€" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Tarrina de Salsa Ranch FRY", desc: "Mayonesa, yogur griego, zumo de limón, zumo de pepinillo y cilantro fresco. Disponible en 40g o tarrina grande ±200g.", price: "1,20€" },
          { name: "Tarrina de Salsa Habanero Mango", desc: "40 g. Mango fresco y habanero, picante afrutado y con punch.", price: "1,20€" },
          { name: "Tarrina de Miel", desc: "40 g. Miel líquida para mojar o echar por encima.", price: "1,50€" },
        ],
      },
      {
        id: "bebidas",
