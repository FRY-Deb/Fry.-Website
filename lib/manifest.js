  ...
  window.__BRAND__ = {
    ...
    categories: [
      ...
      },
      {
        id: "ensaladas",
        label: "Ensaladas",
        note: "Recién hechas, para compartir o de plato único. Elige el tamaño.",
        items: [
          { name: "Ensalada Crab Roll", desc: "Pepino, delicias de cangrejo, aguacate, queso crema y un toque de limón, con nuestro topping crujiente. 450ml o 950ml.", price: "6,00€" },
          { name: "Ensalada Santorini", desc: "Pepino, cebolla roja, carne de ternera, aguacate, yogur griego, queso feta y cilantro, con un toque de guindilla. 450ml o 950ml.", price: "6,00€" },
          { name: "Ensalada Vegetal", desc: "Pepino, edamame, aguacate y cilantro, con salsa picante, salsa de soja y semillas de sésamo. 450ml o 950ml.", price: "6,00€" },
        ],
      },
      {
        id: "guarniciones",
