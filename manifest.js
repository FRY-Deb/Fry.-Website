(function () {
  ...
  window.__BRAND__ = {
    ...
    categories: [
      {
        ...
        label: "Combos Mixtos",
        items: [
          { name: "Fiesta Mixta", desc: "4 piezas de pechuga + 4 hamburguesas FRY. + 2 patatas medianas + 1 bebida de 2L + 2 cubos de Salsa FRY. incluidos.", price: "56,90€" },
        ],
      },
      {
        id: "piezas",
        ...
        items: [
          { name: "Ración 2 Piezas", desc: "2 piezas de pechuga entera — para 1-2 personas. Incluye 1 cubo de Salsa FRY.", price: "11,50€", highlight: true },
        ],
      },
      {
        id: "tiras",
    ...
    combos: [
      { name: "Fiesta Mixta", price: "56,90€", tag: "4 piezas + 4 hamburguesas + 2 patatas medianas + 1 bebida de 2L + 2 cubos de Salsa FRY." },
